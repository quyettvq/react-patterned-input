...
export default class PatternedInput extends React.Component {
    ...
    getSelectPiece = (pieceCnf, disabled) => {
        /**
         * Not implemented yet
         */
        return <SelectPiece/>;
    ...
    getPiece = (pieceCnf, disabled) => {
        ...
        if (pieceCnf.type === PIECE_SELECT) {
            return this.getSelectPiece(pieceCnf, disabled);
        }
    };
...
PatternedInput.defaultProps = {
    defaultValues: null,
    values: undefined,
    template: [],
    onChange: (values) => console.log('(PatternedInput) onChange is omitted', values),
    onFocus: (key) => {},
    onBlurAll: () => {},
